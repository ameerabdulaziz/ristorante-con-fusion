...
class ContactComponent extends Component {
    ...
    handleSubmit(values) {
        ...
        this.props.postFeedback(values.firstName, values.lastName, values.phone, values.email, values.agree,
            values.contentType, values.message);
    }
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text className="form-control" id="first-name" placeholder="First Name"
                                                  name="firstName"
                                                  model=".firstName"
                                                  validators={{
                                                      required,
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text className="form-control" id="last-name" placeholder="Last Name"
                                                  name="lastName"
                                                  model=".lastName"
                                                  validators={{
                                                      required,
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text className="form-control" id="phone" placeholder="Phone"
                                                  name="phone"
                                                  model=".phone"
                                                  validators={{
                                                      required,
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text className="form-control" id="email" placeholder="Email"
                                                  name="email"
                                                  model=".email"
                                                  validators={{
                                                      validEmail
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea className="form-control" id="message" rows="12"
                                                      name="message"
                                                      model=".message"
                                    />
                                </Col>
